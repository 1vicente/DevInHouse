...
describe('AppComponent', () => {
  ...
  it(`should have as title 'projeto-aulas-semana2'`, () => {
    const fixture = TestBed.createComponent(AppComponent);
    const app = fixture.componentInstance;
    expect(app.title).toEqual('projeto-aulas-semana2');
  });
  ...
  it('should render title', () => {
    ...
    expect(compiled.querySelector('.content span')?.textContent).toContain('projeto-aulas-semana2 app is running!');
  });

  it('Encontra Resource na página', () => {
    const fixture = TestBed.createComponent(AppComponent);
    const compiled = fixture.debugElement.nativeElement.querySelectorAll('h2')
    expect(compiled[0]?.textContent).toBe('Resources')
  })

  it('Encontra tag Imagem na página', () => {
    const fixture = TestBed.createComponent(AppComponent);
